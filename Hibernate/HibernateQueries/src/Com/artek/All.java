  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("SELECT firstname from User u where u.id = all (select id from Emp  where lname='panwar') ");
			   ...
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("select firstname from UserDTO u where u.id = all (select id from EmpDTO  where lname='panwar')");
