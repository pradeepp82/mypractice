  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("SELECT * FROM User WHERE id BETWEEN 1 AND 4;");
			   List l =q.list();
			   Iterator itr =l.iterator();
			   while(itr.hasNext()){
				   
				   Object [] s= (Object [])itr.next();
				   System.out.println(s[0]+" "+s[1]+" "+s[1]);
				   
			   }
			   
		   }else if(choice==2){
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("from UserDTO where id between 1 and 3  ");
