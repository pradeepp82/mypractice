  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("SELECT *  FROM User where not firstname='pradeep' and lastname='mandloi';");
			   List l =q.list();
			   ...
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("from UserDTO where not firstname='pradeep' or lastname='mandloi' ");
