  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("select count(u.firstname) as uc,u.lastname from User u");
			   List l =q.list();
			   ...
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("select u.firstname  from UserDTO u where lastname='mandloi'  ");
