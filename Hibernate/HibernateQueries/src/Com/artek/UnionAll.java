  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("SELECT firstname FROM User UNION all SELECT name FROM Emp ;");
			   List l =q.list();
			   ...
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("SELECT firstname FROM UserDTO UNION all SELECT name FROM EmpDTO");
