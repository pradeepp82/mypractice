  ...
  public static void main(String[] args) {
		  ...
		  Scanner sc=new Scanner(System.in);  
		   ...
		   if(choice==1){
			   ...
			   Query q=session.createSQLQuery("SELECT COUNT(id), firstname FROM User GROUP BY lastname;");
			   ...
			   System.out.println(" you are selected hql query");
                 Query q1 = session.createQuery("SELECT COUNT(id), firstname FROM UserDTO GROUP BY lastname");
